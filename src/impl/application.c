...
application_t *parse_application(JSON_Value *application_value) {
    ...
    *result = (application_t) {(char *) json_object_get_string(application, "id"),
                               ...
                               (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(application, "rpc_origins"))),
                               json_object_get_boolean(application, "bot_public"),
                               json_object_get_boolean(application, "bot_require_code_grant"),
                               (char *) json_object_get_string(application, "terms_of_service_url"),
                               (char *) json_object_get_string(application, "privacy_policy_url"),
                               (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(application, "owner"))),
                               (char *) json_object_get_string(application, "summary"),
                               (char *) json_object_get_string(application, "verify_key"),
                               (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(application, "team"))),
