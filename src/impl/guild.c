...
guild_t *parse_guild(JSON_Value *guild_value) {
    ...
    *result = (guild_t) {(char *) json_object_get_string(guild, "id"),
                         ...
                         (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild, "welcome_screen"))),
                         (int) json_object_get_number(guild, "nsfw_level"),
                         (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(guild, "stage_instances"))),
                         (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(guild, "stickers"))),
                         (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(guild, "guild_scheduled_events"))),
                         json_object_get_boolean(guild, "premium_progress_bar_enabled ")
    };
...
guild_preview_t *parse_guild_preview(JSON_Value *guild_preview_value) {
    ...
    *result = (guild_preview_t) {(char *) json_object_get_string(guild_preview, "id"),
                                 ...
                                 (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(guild_preview, "emojis"))),
                                 (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(guild_preview, "features"))),
...
guild_widget_t *parse_guild_widget(JSON_Value *guild_widget_value) {
    ...
    *result = (guild_widget_t) {json_object_get_boolean(guild_widget, "enabled"),
...
guild_member_t *parse_guild_member(JSON_Value *guild_member_value) {
    ...
    *result = (guild_member_t) {(char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_member, "user"))),
                                (char *) json_object_get_string(guild_member, "nick"),
                                (char *) json_object_get_string(guild_member, "avatar"),
                                (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(guild_member, "roles"))),
                                (char *) json_object_get_string(guild_member, "joined_at"),
                                (char *) json_object_get_string(guild_member, "premium_since"),
                                json_object_get_boolean(guild_member, "deaf"),
                                json_object_get_boolean(guild_member, "mute"),
                                json_object_get_boolean(guild_member, "pending"),
...
ban_t *parse_ban(JSON_Value *ban_value) {
    ...
    *result = (ban_t) {(char *) json_object_get_string(ban, "reason"),
                       (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(ban, "user")))
    };
...
welcome_screen_t *parse_welcome_screen(JSON_Value *welcome_screen_value) {
    ...
    *result = (welcome_screen_t) {(char *) json_object_get_string(welcome_screen, "description"),
                                  (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(welcome_screen, "welcome_channels")))
    };
...
guild_scheduled_event_t *parse_guild_scheduled_event(JSON_Value *guild_scheduled_event_value) {
    ...
    *result = (guild_scheduled_event_t) {(char *) json_object_get_string(guild_scheduled_event, "id"),
                                         ...
                                         (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event, "privacy_level"))),
                                         (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event, "status"))),
                                         (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event, "entity_type"))),
                                         (char *) json_object_get_string(guild_scheduled_event, "entity_id"),
                                         (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event, "entity_metadata **"))),
                                         (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event, "creator"))),
...
guild_scheduled_event_user_t *parse_guild_scheduled_event_user(JSON_Value *guild_scheduled_event_user_value) {
    ...
    *result = (guild_scheduled_event_user_t) {(char *) json_object_get_string(guild_scheduled_event_user, "guild_scheduled_event_id "),
                                              (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event_user, "user"))),
                                              (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_scheduled_event_user, "member")))
    };
...
guild_template_t *parse_guild_template(JSON_Value *guild_template_value) {
    ...
    *result = (guild_template_t) {(char *) json_object_get_string(guild_template, "code"),
                                  ...
                                  (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_template, "creator"))),
                                  ...
                                  (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(guild_template, "serialized_source_guild"))),
                                  json_object_get_boolean(guild_template, "is_dirty")
    };
