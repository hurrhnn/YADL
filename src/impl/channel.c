...
channel_t *parse_channel(JSON_Value *channel_value) {
    ...
    *result = (channel_t) {(char *) json_object_get_string(channel, "id"),
                           ...
                           (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(channel, "permission_overwrites"))),
                           (char *) json_object_get_string(channel, "name"),
                           (char *) json_object_get_string(channel, "topic"),
                           json_object_get_boolean(channel, "nsfw"),
                           ...
                           (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(channel, "recipients"))),
                           ...
                           (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(channel, "thread_metadata"))),
                           (char *) json_serialize_to_string(json_object_get_wrapping_value(json_object_get_object(channel, "member"))),
...
allowed_mentions_t *parse_allowed_mentions(JSON_Value *allowed_mentions_value) {
    ...
    *result = (allowed_mentions_t) {(char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(allowed_mentions, "parse"))),
                                    (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(allowed_mentions, "roles"))),
                                    (char *) json_serialize_to_string(json_array_get_wrapping_value(json_object_get_array(allowed_mentions, "users"))),
                                    json_object_get_boolean(allowed_mentions, "replied_user")
    };
